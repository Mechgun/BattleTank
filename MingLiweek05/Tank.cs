...
namespace MingLiweek05
{
    class Tank : BasicModel
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.W) && speed < 0.2f && speed > -0.2f)
            { speed += Acceleration; }


            if (Keyboard.GetState().IsKeyDown(Keys.S) && speed < 0 && speed > -0.2f)
            { speed -= Acceleration / 4; }

            if (Keyboard.GetState().IsKeyDown(Keys.S) && speed < 0.2f && speed > 0)
            { speed -= Acceleration * 5; }

            if (Keyboard.GetState().IsKeyUp(Keys.W) && Keyboard.GetState().IsKeyUp(Keys.S) && speed < -0.03f)
            {
                speed += Resistance;
            }
            if (Keyboard.GetState().IsKeyUp(Keys.W) && Keyboard.GetState().IsKeyUp(Keys.S) && speed > 0.03f)
            ...
            if (Keyboard.GetState().IsKeyUp(Keys.W) && Keyboard.GetState().IsKeyUp(Keys.S) && speed > -0.03f && speed < 0.03f)
            {
                speed = 0;
            }
